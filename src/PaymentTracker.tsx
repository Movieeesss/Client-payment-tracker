    ...
    <div style={{ margin: 0, padding: 0, background: '#f1f5f9', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .inv-table th { 
          padding: 8px 4px; font-size: 9px; font-weight: 900;
        ...
        .col-desc { padding-left: 8px !important; padding-right: 4px !important; }
        ...
        .col-desc-head { text-align: left; padding-left: 8px !important; }
        .add-item-btn {
          padding: 10px 12px; color: #2563eb; font-weight: 900; font-size: 10px;
        ...
        .adv-symbol { font-size: 10px; color: #10b981; opacity: 0.6; }
        ...
        .bank-section { flex: 1; }
        .bank-label { font-size: 9px; font-weight: 900; color: #2563eb; text-transform: uppercase; letter-spacing: 0.1em; display: flex; align-items: center; gap: 4px; margin-bottom: 6px; }
        .bank-input { display: block; width: 100%; border: none; outline: none; background: transparent; }
        .bank-name { font-size: 11px; font-weight: 900; text-transform: uppercase; color: #0f172a; }
        .bank-acc-name { font-size: 10px; font-weight: 700; color: #64748b; }
        .bank-acc-no { font-size: 10px; color: #94a3b8; font-family: monospace; }
        ...
        .qr-scan-text { font-size: 8px; font-weight: 700; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.08em; }
        .footer-note { font-size: 9px; color: #94a3b8; font-style: italic; line-height: 1.5; text-align: center; }
        ...
        .btn-reset {
          width: 100%; background: white; color: #ef4444;
          padding: 12px; border-radius: 14px;
          font-weight: 900; font-size: 11px; text-transform: uppercase;
          display: flex; align-items: center; justify-content: center; gap: 8px;
          border: 1px solid #fee2e2; cursor: pointer; letter-spacing: 0.08em;
          -webkit-tap-highlight-color: transparent;
        }
        .footer-brand {
          ...
          <table className="inv-table">
            <thead>
              <tr>
                ...
                <th className="col-desc-head">DESCRIPTION</th>
            ...
            <tbody>
              {rows.map((row, index) => (
                <tr key={row.id}>
                  ...
                  <td className="col-amt" style={{ fontWeight: 900, textAlign: 'right' }}>
        ...
        <div className="inv-footer">
          <div className="footer-top">
            <div className="bank-section">
              ...
              <input className="bank-input bank-acc-name" value={accName} onChange={e => setAccName(e.target.value)} />
              <input className="bank-input bank-acc-no" value={accNo} onChange={e => setAccNo(e.target.value)} />
            </div>
            <div className="qr-wrap">
              <div className="qr-box no-print" onClick={() => qrRef.current?.click()}>
                {qrCode ? <img src={qrCode} alt="QR" /> : <><QrCode size={18} color="#cbd5e1" /><span style={{ fontSize: 7, color: '#94a3b8', fontWeight: 700, marginTop: 2 }}>QR</span></>}
